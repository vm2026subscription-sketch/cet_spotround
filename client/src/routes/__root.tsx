  ...
  head: () => ({
    meta: [
      ...
      { title: "Virtual CAP Admission Portal | Maharashtra Engineering Admissions" },
      {
        name: "description",
        content:
          "Official Virtual CAP admission portal for engineering and technical admissions in Maharashtra. Track vacant seats, file preferences, and view seat allotment results.",
      },
      { name: "author", content: "Virtual CAP Portal" },
      { property: "og:title", content: "Virtual CAP Admission Portal" },
      {
